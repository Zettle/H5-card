...
var H5ComponentBase = function (name, cfg) {
    ...
    cfg.css = Object.assign(cfg.css || {}, cfg.animateOut || {});
    ...
    component.on('load', function () {
        var that = this;
        setTimeout(function () {
            $(that).addClass('h5_component_load').removeClass('h5_component_leave');
    ...
    component.on('leave', function () {
        var that = this;
        setTimeout(function () {
            $(that).addClass('h5_component_leave').removeClass('h5_component_load');
...
var H5ComponentPie = function (name, cfg) {
    ...
    for (var i=0; i<cfg.data.length; i++) {
        ...
        txt.css({ transition: `all 1s ${0.1 * i}s`, opacity: 0});
        component.append(txt);
    }
