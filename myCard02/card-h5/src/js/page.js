...
class Page {
    constructor () {
        ...
        this.disY = 0;
        this._currentPageIndex = 0; // 默认第一张开始，下标0开始
    }
    get $currentPage () {
    ...
    init () {
        ...
        this.startMove(this.currentPageIndex); // 开始第1张的动画，从this.currentPageIndex开始
        ...
        let touchObj = new Touch({
            ...
            touchEndHandle: () => {
                ...
                if (this.disY < 0) {
                    ...
                    this.$currentPage.addClass('transition').css({
                        transform: `translate3d(0, -${this.screenSize.height}px, 0)`
                    });
            ...
            swipeUp: (dis) => {
                ...
                this.$nextPage.addClass('visible').css({
                    transform: `translate3d(0, ${this.screenSize.height + this.disY}px, 0)`
                });
